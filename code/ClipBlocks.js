...
class ClipBlocks {
        ...
        return {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    text: 'set the visibility of all sprite to [BOOLEANMENU]',
                    blockType: BlockType.COMMAND,
                    arguments: {
                        BOOLEANMENU: {
                            type: ArgumentType.STRING,
                ...
                {
                    opcode: 'showDialog',
                    text: 'show dialog title:[TITLE] content: [CONTENT] left-layout: [BOOLEANMENU] buttontext:[BUTTONTEXT] ',
                    blockType: BlockType.COMMAND,
                    arguments: {
                        TITLE: {
                            type: ArgumentType.STRING,
                ...
                },
                {
                    ...
                    text: 'set [FLASHEFFECT] flash effect to [VALUE1] [VALUE2] [VALUE3]',
                    blockType: BlockType.COMMAND,
                    arguments: {
                        FLASHEFFECT: {
                            type: ArgumentType.STRING,
                ...
                },
                {
                    ...
                    text: 'clear all flash effect',
                    blockType: BlockType.COMMAND
                },
                {
                    opcode: 'setClipboard',
                    text: 'set the content of clipboard to [TEXT]',
                    blockType: BlockType.COMMAND,
                    arguments: {
                        TEXT: {
                            type: ArgumentType.STRING,
	...
	Scratch.extensions.register(new ClipBlocks());
  })(Scratch);