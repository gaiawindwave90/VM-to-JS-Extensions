...
class Scratch3PuzzleBlocks {
    ...
    getInfo() {
        return {
            ...
            blocks: [{
                    ...
                    text: 'Conver paint to watermark'
                },
                {
                ...
                },
                {
                    ...
                    text: 'Is paint the same as watermark?'
                },
                {
                    opcode: 'attemptCount',
                ...
                },
                {
                    ...
                    blockType: BlockType.COMMAND,
                    text: 'Set Sprite tracker [TRACKER]',
                    arguments: {
                        TRACKER: {
                ...
                },
                {
                    ...
                    blockType: BlockType.COMMAND,
                    text: 'Create reporter type [REPORTER_TYPE] name [REPORTER_NAME]',
                    arguments: {
                        REPORTER_TYPE: {
                            type: ArgumentType.STRING,
                            menu: 'REPORTER_TYPE',
                ...
                },
                {
                    ...
                    blockType: BlockType.COMMAND,
                    text: 'Set Reporter name [REPORTER_NAME] value [VAL]',
                    arguments: {
                        REPORTER_NAME: {
                            type: ArgumentType.STRING,
                ...
                },
                {
                    ...
                    blockType: BlockType.COMMAND,
                    text: 'Set boolean [REPORTER_NAME] value [VAL]',
                    arguments: {
                        REPORTER_NAME: {
                            type: ArgumentType.STRING,
	...
	Scratch.extensions.register(new Scratch3PuzzleBlocks());
  })(Scratch);
